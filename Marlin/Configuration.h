...
#define STRING_CONFIG_H_AUTHOR "(tchleb, 3 + SKR 1.3 + TMMC2208 + IR Z Probe)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.81, 78.81, 399.73, 1087.22 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, 0, -1 } //XYZ
